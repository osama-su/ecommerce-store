                                ...
                                <div class="card-body card-dashboard">
                                    <table class="table display nowrap table-striped table-bordered scroll-horizontal">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$vendor -> name}}</td>
                                                <td><img style="width:100px; height:100px;" src="{{$vendor -> logo}}" alt="ee"></td>
                                                <td>{{$vendor -> mobile}}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group" role="group" aria-label="Basic example">
                                                        ...
                                                        <a href="{{route('admin.vendors.delete',$vendor -> id)}}" class="btn btn-outline-warning btn-min-width box-shadow-3 mr-1 mb-1">تفعيل</a>
                                                    </div>
                                                </td>
                                            </tr>
                                            @endforeach
