    ...
    <div class="content">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 d-flex justify-content-end align-items-center header-top-right">
            ...
            <div class="language-list dropdown-menu">
              <div class="language-list-content text-left">
                <div class="language-item">
                  <div>
                    <a href="http://demo.bestprestashoptheme.com/savemart/en/?home=home_3">
          ...
          <div class="register-out">
            <i class="zmdi zmdi-account"></i>
            <a class="login" href="{{route('admin.dashboard')}}" rel="nofollow" title="تسجيل الدخول إلى حسابك">Admin</a>
          </div>
